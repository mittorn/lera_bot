			...
			for result in updates:
				if result[0] == 4:
					...
					if len(answ) > 1:
						...
						answ[0] = answ[0].lower()
						answ[1] = answ[1].lower()
						if (str(userid) not in game_module['active_users'] and (answ[0] in kb_name or answ[0] in kb_name+',') and ((answ[1] in kb_cmd["default"]) or (answ[1] in kb_cmd["vip"]) or (answ[1] in kb_cmd["admin"]))):
						...
						if ((answ[0] in kb_name or answ[0] in kb_name+',') and (answ[1] not in kb_cmd["default"]) and (answ[1] not in kb_cmd["vip"]) and (answ[1] not in kb_cmd["admin"]) and (str(userid) not in game_module['active_users'])):
